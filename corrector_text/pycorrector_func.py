from pycorrector import T5Corrector, Corrector, MacBertCorrector
...
con1 = '习近屏：继续保持密切交往，确保中俄关系始终顺利稳定向前发展'
...
con51 = '少先队员因该为老人让坐，你找到你最喜欢的工作，我也很高心。'
con52 = '最早开的花不仅引人注目，而且能够吸引刚从蛰伏中醒来的传粉昆虫。由于比其他花开得早，因而要承但相应的风险：它们可能遭遇降雪，或者其他娄型的寒冻伤害。不考虑城市绿地和公园中栽种的花，每年春天在原野上或者山谷间最先绽放的野花都有谁呢？'
con53 = '每年到了春天，都是万物付苏的时候，一片春意昂然，百花开的诧紫嫣红的，好看极了了。'
...
# res = m.correct_batch([con3])
# for j in res:
#     print(j)

res = m.correct(sentence=con53)
print(res)